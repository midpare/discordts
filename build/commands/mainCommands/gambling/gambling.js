                ...
                switch (_b.label) {
                    case 0:
                        ...
                        if (!Number.isInteger(money) || money <= 0)
                            return [2 /*return*/, msg.reply('정확한 자연수를 입력해주시길 바랍니다.')];
                    ...
                    case 1:
                        ...
                        if (money > user.money)
                            return [2 /*return*/, msg.reply("\uD604\uC7AC \uC794\uC561\uBCF4\uB2E4 \uB192\uC740 \uB3C8\uC740 \uC785\uB825\uD558\uC2E4 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4.  \n\uD604\uC7AC\uC794\uC561: " + user.money + "\uC6D0")];
                        random = Math.floor(Math.random() * 2);
                        if (random == 1) {
                            gambling_1.gambling.updateOne({ id: id }, { $inc: { money: money } })
                                .then(function () { return msg.reply("\uB3C4\uBC15\uC5D0 \uC131\uACF5\uD558\uC168\uC2B5\uB2C8\uB2E4! " + money.toLocaleString() + "\uC6D0\uC774 \uC9C0\uAE09\uB418\uC5C8\uC2B5\uB2C8\uB2E4. \n\uD604\uC7AC \uC794\uC561: " + user.money.toLocaleString() + "\uC6D0 -> " + (user.money + money).toLocaleString() + "\uC6D0"); });
                        }
                        else if (random == 0) {
                            gambling_1.gambling.updateOne({ id: id }, { $inc: { money: -money } })
                                .then(function () { return msg.reply("\uB3C4\uBC15\uC5D0 \uC2E4\uD328\uD558\uC168\uC2B5\uB2C8\uB2E4! " + money.toLocaleString() + "\uC6D0\uC774 \uCC28\uAC10\uB418\uC5C8\uC2B5\uB2C8\uB2E4. \n\uD604\uC7AC \uC794\uC561: " + user.money.toLocaleString() + "\uC6D0 -> " + (user.money - money).toLocaleString() + "\uC6D0"); });
                        }
                        return [2 /*return*/];
                }
            });
