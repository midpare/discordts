            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        if (random == 1) {
                            gambling_1.gambling.updateOne({ id: id }, { $set: { money: Math.floor(money * 1.5) } })
                                .then(function () { return msg.reply("\uB3C4\uBC15\uC5D0 \uC131\uACF5\uD558\uC168\uC2B5\uB2C8\uB2E4! " + Math.round(user.money * 0.5).toLocaleString() + "\uC6D0\uC774 \uC9C0\uAE09\uB418\uC5C8\uC2B5\uB2C8\uB2E4. \n\uD604\uC7AC \uC794\uC561: " + user.money.toLocaleString() + "\uC6D0 -> " + Math.round(user.money * 1.5).toLocaleString() + "\uC6D0"); });
                        }
                        else if (random == 0) {
                            gambling_1.gambling.updateOne({ id: id }, { $set: { money: Math.floor(money * 0.5) } })
                                .then(function () { return msg.reply("\uB3C4\uBC15\uC5D0 \uC2E4\uD328\uD558\uC168\uC2B5\uB2C8\uB2E4! " + Math.round(user.money * 0.5).toLocaleString() + "\uC6D0\uC744 \uC783\uC5C8\uC2B5\uB2C8\uB2E4. \n \uD604\uC7AC \uC794\uC561 " + user.money.toLocaleString() + "\uC6D0 -> " + Math.round(user.money * 0.5).toLocaleString() + "\uC6D0"); });
                        }
                        return [2 /*return*/];
                }
            });
