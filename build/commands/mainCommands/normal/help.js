...
module.exports = {
    ...
    execute: function (_a) {
        ...
        var embed = new discord_js_1.MessageEmbed().setDescription('카테고리를 선택해주시기바랍니다.');
        var components = new discord_js_1.MessageActionRow().addComponents(new discord_js_1.MessageSelectMenu()
            .setCustomId('help')
        ...
        var initialMessage = msg.channel.send({ embeds: [embed], components: [components] });
