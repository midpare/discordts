...
module.exports = {
    ...
    execute: function (_a) {
        ...
        return __awaiter(void 0, void 0, void 0, function () {
            var id, user, stock, coinName, userCoin, coin, count, coinMoney, wholeMoney, moneyAve_1, stockObject;
                ...
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        if (!Number.isInteger(count) || count <= 0)
                            return [2 /*return*/, msg.reply('정확한 구매 수량을 입력해주시기바랍니다.')];
                        coinMoney = coin[0].tradePrice;
                        wholeMoney = coinMoney * count;
