...
exports.default = new Command_1.Command({
    ...
    execute: ({ interaction, options, client }) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const channel1 = (_a = client.guilds.cache.get(guildId)) === null || _a === void 0 ? void 0 : _a.channels.cache.get(alarmChannel[0]);
        const channel2 = (_b = client.guilds.cache.get(guildId)) === null || _b === void 0 ? void 0 : _b.channels.cache.get(alarmChannel[1]);
