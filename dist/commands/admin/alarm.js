...
exports.default = new Command_1.Command({
    ...
    execute: ({ interaction, options, client }) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const channel1 = (_a = client.guilds.cache.get(guildId)) === null || _a === void 0 ? void 0 : _a.channels.cache.get((_b = guild.alarmChannel[0]) !== null && _b !== void 0 ? _b : '0');
        const channel2 = (_c = client.guilds.cache.get(guildId)) === null || _c === void 0 ? void 0 : _c.channels.cache.get((_d = guild.alarmChannel[1]) !== null && _d !== void 0 ? _d : '0');
