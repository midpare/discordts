...
exports.default = new Commands_1.Command({
    ...
    execute: ({ msg, args, client }) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        if (user.money != 0 || user.stock[0])
            return msg.reply(message_1.messages.gambling.baseMoney.haveMoney);
        ...
        if (user.baseMoneyCoolTime) {
            ...
            if ((second - userCoolTime) / 1000 < coolTime)
                return msg.reply(message_1.messages.coolTime(Math.ceil(coolTime - (second - userCoolTime) / 1000)));
        }
        const baseMoney = 25000;
        (yield gambling_1.gambling.updateOne({ id }, { $set: { money: baseMoney, baseMoneyCoolTime: second } })).matchedCount;
        msg.reply(message_1.messages.gambling.baseMoney.success(baseMoney));
    }),
});
